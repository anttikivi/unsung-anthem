...
class FreeBSD(GenericUnix):
    def __init__(self):
        ...
        # Building Unsung Anthem from source requires a recent version of the
        # Clang compiler with C++14 support.
...
def host_toolchain(**kwargs):
    ...
    if sys == 'Darwin':
        ...
        raise NotImplementedError('The platform "{}" does not have a defined '
