...
The guidelines and other documentation hosted in this repository are also applied to other projects that support Unsung Anthem and Obliging Ode. Those project include the build script and licence-to-be of Unsung Anthem and Obliging Ode. All of the projects and their Git repositories are:
