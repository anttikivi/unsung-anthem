...
function(ADD_DIRECTORY_DEFINITIONS)
  if(WIN32)
    ...
    add_definitions(-DODE_SCRIPT_ROOT="${ODE_WINDOWS_SCRIPT_PATH}\\\\lib\\\\ode")
    add_definitions(-DODE_TEST_SCRIPT_ROOT="${ODE_WINDOWS_SCRIPT_PATH}\\\\lib\\\\ode")
    add_definitions(-DANTHEM_SCRIPT_ROOT="${ODE_WINDOWS_SCRIPT_PATH}\\\\lib\\\\anthem")
    add_definitions(-DANTHEM_TEST_SCRIPT_ROOT="${ODE_WINDOWS_SCRIPT_PATH}\\\\lib\\\\anthem")
  else()
