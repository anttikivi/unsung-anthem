...
function(ADD_FEATURE_DEFINITIONS)
  ...
  if(ODE_MULTITHREADING)
    ...
    add_definitions(-DODE_PRINT_MULTITHREADING_WARNING=1)
    info("Please note that multithreading is not currently supported")
  else()
    add_definitions(-DODE_MULTITHREADING=0)
    add_definitions(-DANTHEM_MULTITHREADING=0)
    add_definitions(-DODE_PRINT_MULTITHREADING_WARNING=0)
  endif()
